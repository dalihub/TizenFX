...
namespace Tizen.NUI.Xaml.Forms.BaseComponents
{
    ...
    public class CustomView : View
    {
        ...
        private class ConstructData
        {
            ...
            internal CustomViewBehaviour behaviour;
        }

        protected override Tizen.NUI.BaseHandle GetNUIInstance(object Data)
        {
            ConstructData data = (ConstructData)Data;

            return new Tizen.NUI.BaseComponents.CustomView(data.typeName, data.behaviour);
        }
