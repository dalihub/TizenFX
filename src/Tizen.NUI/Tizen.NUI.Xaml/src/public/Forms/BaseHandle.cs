...
namespace Tizen.NUI.Xaml.Forms
{
    ...
    public class BaseHandle : Element, global::System.IDisposable
    {
        ...
        virtual protected Tizen.NUI.BaseHandle GetNUIInstance()
        {
            Tizen.NUI.BaseHandle result = new Tizen.NUI.BaseHandle();
            return result;
        }

        virtual protected Tizen.NUI.BaseHandle GetNUIInstance(object Data)
        {
            Tizen.NUI.BaseHandle result = new Tizen.NUI.BaseHandle();
            return result;
        }
        ...
        public BaseHandle(object Data)
        {
            handle = GetNUIInstance(Data);
