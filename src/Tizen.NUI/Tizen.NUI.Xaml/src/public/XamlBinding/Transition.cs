...
namespace Tizen.NUI
{
    ...
    public class Transition : Tizen.NUI.Xaml.Forms.BaseHandle
    {
        ...
        {
            return new Tizen.NUI.Animation();
        }

        protected override Tizen.NUI.BaseHandle GetNUIInstance(object duration)
        {
            int durationMilliSeconds = (int)duration;
            return new Tizen.NUI.Animation(durationMilliSeconds);
        }
        ...
        public Transition(int durationMilliSeconds) : base(durationMilliSeconds)
        {
        ...
        internal object ConvertTo(object value, Type toType, Func<object> getConverter)
        {
            ...
            if (str != null)
            {
                ...
                var xfTypeConverter = converter as Binding.TypeConverter;
        ...
        internal string GetTypeConverterTypeName(IEnumerable<CustomAttributeData> attributes)
        {
            var converterAttribute =
                attributes.FirstOrDefault(cad => Binding.TypeConverterAttribute.TypeConvertersType.Contains(cad.AttributeType.FullName));
