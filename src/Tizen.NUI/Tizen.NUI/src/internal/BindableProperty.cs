...
namespace Tizen.NUI
{
    ...
    public sealed class TizenNUIProperty
    {
        /// <summary>
        ...
        TizenNUIProperty(string propertyName, Type returnType, Type declaringType, object defaultValue, BindingPropertyChangedDelegate propertyChanged, CreateDefaultValueDelegate defaultValueCreator)
        {
        ...
        public static TizenNUIProperty Create(string propertyName, Type returnType, Type declaringType, object defaultValue = null,
                                              BindingPropertyChangedDelegate propertyChanged = null,
                                              CreateDefaultValueDelegate defaultValueCreator = null)
        {
            return new TizenNUIProperty(propertyName, returnType, declaringType, defaultValue, propertyChanged:propertyChanged, defaultValueCreator: defaultValueCreator);
        }
