...
namespace Tizen.NUI.BaseComponents
{
    ...
    public class CustomView : ViewWrapper
    {
        ...
        public static readonly TizenNUIProperty FocusNavigationSupportProperty = TizenNUIProperty.Create("FocusNavigationSupport", typeof(bool), typeof(CustomView), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty FocusGroupProperty = TizenNUIProperty.Create("FocusGroup", typeof(bool), typeof(CustomView), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var customView = (CustomView)bindable;
            if (newValue != null)
            {
