...
namespace Tizen.NUI.UIComponents
{
    ...
    public class Button : View
    {
        ...
        public static readonly TizenNUIProperty UnselectedVisualProperty = TizenNUIProperty.Create("UnselectedVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty SelectedVisualProperty = TizenNUIProperty.Create("SelectedVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty DisabledSelectedVisualProperty = TizenNUIProperty.Create("DisabledSelectedVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty DisabledUnselectedVisualProperty = TizenNUIProperty.Create("DisabledUnselectedVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty UnselectedBackgroundVisualProperty = TizenNUIProperty.Create("UnselectedBackgroundVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty SelectedBackgroundVisualProperty = TizenNUIProperty.Create("SelectedBackgroundVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty DisabledUnselectedBackgroundVisualProperty = TizenNUIProperty.Create("DisabledUnselectedBackgroundVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty DisabledSelectedBackgroundVisualProperty = TizenNUIProperty.Create("DisabledSelectedBackgroundVisual", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty LabelRelativeAlignmentProperty = TizenNUIProperty.Create("LabelRelativeAlignment", typeof(Align), typeof(Button), Align.End, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty LabelPaddingProperty = TizenNUIProperty.Create("LabelPadding", typeof(Vector4), typeof(Button), Vector4.Zero, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty ForegroundVisualPaddingProperty = TizenNUIProperty.Create("ForegroundVisualPadding", typeof(Vector4), typeof(Button), Vector4.Zero, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty AutoRepeatingProperty = TizenNUIProperty.Create("AutoRepeating", typeof(bool), typeof(Button), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty InitialAutoRepeatingDelayProperty = TizenNUIProperty.Create("InitialAutoRepeatingDelay", typeof(float), typeof(Button), default(float), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty NextAutoRepeatingDelayProperty = TizenNUIProperty.Create("NextAutoRepeatingDelay", typeof(float), typeof(Button), default(float), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty TogglableProperty = TizenNUIProperty.Create("Togglable", typeof(bool), typeof(Button), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty SelectedProperty = TizenNUIProperty.Create("Selected", typeof(bool), typeof(Button), false, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty UnselectedColorProperty = TizenNUIProperty.Create("UnselectedColor", typeof(Color), typeof(Button), Color.Transparent, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty SelectedColorProperty = TizenNUIProperty.Create("SelectedColor", typeof(Color), typeof(Button), Color.Transparent, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty LabelProperty = TizenNUIProperty.Create("Label", typeof(PropertyMap), typeof(Button), new PropertyMap(), propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
        ...
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty LabelTextProperty = TizenNUIProperty.Create("LabelText", typeof(string), typeof(Button), string.Empty, propertyChanged: (bindable, oldValue, newValue) =>
        {
            var button = (Button)bindable;
            if (newValue != null)
            {
