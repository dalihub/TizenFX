...
namespace Tizen.NUI.UIComponents
{
    ...
    public class PushButton : Button
    {
        ...
        public static readonly TizenNUIProperty CommandProperty = TizenNUIProperty.Create("Command", typeof(ICommand), typeof(PushButton), null, null);
        /// This will be public opened in tizen_5.0 after ACR done. Before ACR, need to be hidden as inhouse API.
        [EditorBrowsable(EditorBrowsableState.Never)]
        public static readonly TizenNUIProperty CommandParameterProperty = TizenNUIProperty.Create("CommandParameter", typeof(object), typeof(PushButton), null, null);
