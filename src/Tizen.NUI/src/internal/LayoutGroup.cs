...
namespace Tizen.NUI
{
    ...
    public class LayoutGroup : LayoutGroupWrapper
    {
        ...
        protected virtual void MeasureChild(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutMeasureSpec parentHeightMeasureSpec)
        {
            layoutGroupWrapperImpl.MeasureChildNative(child, parentWidthMeasureSpec, parentHeightMeasureSpec);
        }

        protected virtual void MeasureChildWithMargins(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutLength widthUsed, LayoutMeasureSpec parentHeightMeasureSpec, LayoutLength heightUsed)
        {
