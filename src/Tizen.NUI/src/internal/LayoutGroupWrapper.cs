...
namespace Tizen.NUI
{
    public class LayoutGroupWrapper : LayoutItemWrapper
    {
        ...
        public LayoutItemWrapper GetChildAt(uint index)
        {
            LayoutItemWrapper ret = new LayoutItemWrapper(LayoutPINVOKE.LayoutGroupWrapper_GetChildAt(swigCPtr, index), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        internal LayoutGroupWrapper(LayoutGroupWrapperImpl layoutGroup) : this(LayoutPINVOKE.new_LayoutGroupWrapper__SWIG_2(LayoutGroupWrapperImpl.getCPtr(layoutGroup)), true)
        {
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
