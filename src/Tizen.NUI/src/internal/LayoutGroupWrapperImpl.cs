...
namespace Tizen.NUI
{
    ...
    internal class LayoutGroupWrapperImpl : LayoutItemWrapperImpl
    {
        ...
        public delegate void MeasureChildDelegate(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutMeasureSpec parentHeightMeasureSpec);
        public delegate void MeasureChildWithMarginsDelegate(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutLength widthUsed, LayoutMeasureSpec parentHeightMeasureSpec, LayoutLength heightUsed);
        ...
        public LayoutItemPtr GetChildAt(uint childIndex)
        {
            LayoutItemPtr ret = new LayoutItemPtr(LayoutPINVOKE.LayoutGroupWrapperImpl_GetChildAt(swigCPtr, childIndex), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        public LayoutItemPtr GetChild(uint childId)
        {
            LayoutItemPtr ret = new LayoutItemPtr(LayoutPINVOKE.LayoutGroupWrapperImpl_GetChild(swigCPtr, childId), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        internal void MeasureChildNative(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutMeasureSpec parentHeightMeasureSpec)
        {
            LayoutPINVOKE.LayoutGroupWrapperImpl_MeasureChild(swigCPtr, LayoutItemPtr.getCPtr(child), LayoutMeasureSpec.getCPtr(parentWidthMeasureSpec), LayoutMeasureSpec.getCPtr(parentHeightMeasureSpec));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        internal void MeasureChildWithMarginsNative(LayoutItemPtr child, LayoutMeasureSpec parentWidthMeasureSpec, LayoutLength widthUsed, LayoutMeasureSpec parentHeightMeasureSpec, LayoutLength heightUsed)
        {
            LayoutPINVOKE.LayoutGroupWrapperImpl_MeasureChildWithMargins(swigCPtr, LayoutItemPtr.getCPtr(child), LayoutMeasureSpec.getCPtr(parentWidthMeasureSpec), LayoutLength.getCPtr(widthUsed), LayoutMeasureSpec.getCPtr(parentHeightMeasureSpec), LayoutLength.getCPtr(heightUsed));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
        ...
        {
            MeasureChild(new LayoutItemPtr(child, true), new LayoutMeasureSpec(parentWidthMeasureSpec, true), new LayoutMeasureSpec(parentHeightMeasureSpec, true));
        }
        ...
        {
            MeasureChildWithMargins(new LayoutItemPtr(child, true), new LayoutMeasureSpec(parentWidthMeasureSpec, true), new LayoutLength(widthUsed, true), new LayoutMeasureSpec(parentHeightMeasureSpec, true), new LayoutLength(heightUsed, true));
        }
