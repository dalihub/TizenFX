...
namespace Tizen.NUI
{
    public class LayoutItemPtr : global::System.IDisposable
    {
        ...
        {
            SWIGTYPE_p_Dali__Extents ret = new SWIGTYPE_p_Dali__Extents(LayoutPINVOKE.LayoutItemPtr_GetPadding(swigCPtr), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }*/
