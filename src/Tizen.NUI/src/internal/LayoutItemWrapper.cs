...
namespace Tizen.NUI
{
    public class LayoutItemWrapper : BaseHandle
    {
        ...
        internal LayoutItemWrapper(LayoutItemWrapperImpl LayoutItem) : this(LayoutPINVOKE.new_LayoutItemWrapper__SWIG_2(LayoutItemWrapperImpl.getCPtr(LayoutItem)), true)
        {
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }
    }
