...
namespace Tizen.NUI
{
    internal class LayoutItemWrapperImpl : BaseObject, ILayoutParent
    {
        ...
        /*public SWIGTYPE_p_MeasuredSize GetMeasuredWidthAndState()
        {
            SWIGTYPE_p_MeasuredSize ret = new SWIGTYPE_p_MeasuredSize(LayoutPINVOKE.LayoutItemWrapperImpl_GetMeasuredWidthAndState(swigCPtr), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }

        public SWIGTYPE_p_MeasuredSize GetMeasuredHeightAndState()
        {
            SWIGTYPE_p_MeasuredSize ret = new SWIGTYPE_p_MeasuredSize(LayoutPINVOKE.LayoutItemWrapperImpl_GetMeasuredHeightAndState(swigCPtr), true);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }*/
