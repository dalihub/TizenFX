...
namespace Tizen.NUI
{
    ...
    public class MeasuredSize : global::System.IDisposable
    {
        ...
        public MeasuredSize(LayoutLength measuredSize, MeasuredSize.State state) : this(LayoutPINVOKE.new_MeasuredSize__SWIG_2(LayoutLength.getCPtr(measuredSize), (int)state), true)
        {
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public MeasuredSize Assign(int rhs)
        {
            MeasuredSize ret = new MeasuredSize(LayoutPINVOKE.MeasuredSize_Assign__SWIG_1(swigCPtr, rhs), false);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }

        public bool EqualTo(MeasuredSize value)
        {
        ...
        public bool NotEqualTo(MeasuredSize value)
        {
        ...
        public void SetState(MeasuredSize.State state)
        {
            LayoutPINVOKE.MeasuredSize_SetState(swigCPtr, (int)state);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public MeasuredSize.State GetState()
        {
            MeasuredSize.State ret = (MeasuredSize.State)LayoutPINVOKE.MeasuredSize_GetState(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
