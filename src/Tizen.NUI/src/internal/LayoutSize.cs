...
namespace Tizen.NUI
{
    ...
    public class LayoutSize : global::System.IDisposable
    {
        ...
        public int GetWidth()
        {
            int ret = LayoutPINVOKE.LayoutSize_GetWidth(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            int ret = LayoutPINVOKE.LayoutSize_GetHeight(swigCPtr);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            return ret;
        }
        ...
        {
            LayoutPINVOKE.LayoutSize_SetWidth__SWIG_0(swigCPtr, value);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public void SetHeight(int value)
        {
            LayoutPINVOKE.LayoutSize_SetHeight__SWIG_0(swigCPtr, value);
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public void SetWidth(LayoutLength value)
        {
            LayoutPINVOKE.LayoutSize_SetWidth__SWIG_1(swigCPtr, LayoutLength.getCPtr(value));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public void SetHeight(LayoutLength value)
        {
            LayoutPINVOKE.LayoutSize_SetHeight__SWIG_1(swigCPtr, LayoutLength.getCPtr(value));
            if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
        }

        public bool EqualTo(LayoutSize rhs)
        {
        ...
        public int X
        {
            set
            {
                LayoutPINVOKE.LayoutSize_x_set(swigCPtr, value);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            }
            get
            {
                int ret = LayoutPINVOKE.LayoutSize_x_get(swigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        }
        ...
        public int Y
        {
            set
            {
                LayoutPINVOKE.LayoutSize_y_set(swigCPtr, value);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
            }
            get
            {
                int ret = LayoutPINVOKE.LayoutSize_y_get(swigCPtr);
                if (NDalicPINVOKE.SWIGPendingException.Pending) throw NDalicPINVOKE.SWIGPendingException.Retrieve();
                return ret;
            }
        }
