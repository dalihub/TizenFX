...
//        internal delegate (float width, float height) ChildMeasureCallback(global::System.IntPtr child, float width, int measureModeWidth, float height, int measureModeHeight )
        ...
        protected override void OnChildAdd(LayoutItemEx child)
        {
            InsertChild(child);
        }

        protected override void OnChildRemove(LayoutItemEx child)
        {
    ...
    //     SetChildrenStyle();
        ...
        SetMeasuredDimensions( GetDefaultSize( new LayoutLengthEx( (float)LayoutPINVOKE.FlexLayout_GetWidth(swigCPtr) ), widthMeasureSpec ),
                               GetDefaultSize( new LayoutLengthEx( (float)LayoutPINVOKE.FlexLayout_GetHeight(swigCPtr) ), heightMeasureSpec ) );
        }
