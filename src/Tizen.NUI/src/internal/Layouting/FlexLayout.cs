...
namespace Tizen.NUI
{
    ...
    internal class FlexLayout : LayoutGroupEx
    {
        ...
        void OnChildAdd( LayoutItemEx child )
        {
            ...
            LayoutPINVOKE.FlexLayout_SetContext(node, &child);
            LayoutPINVOKE.FlexLayout_SetMeasureFunction( node, OnChildMeasure );
            LayoutPINVOKE.FlexLayout_MarkDirty( node );
            LayoutPINVOKE.FlexLayout_InsertChild( _yogaRoot, node, _children.Count-1 );
        }
