...
namespace Tizen.NUI
{
    ...
    internal class FlexLayout : LayoutGroup,  global::System.IDisposable
    {
        ...
        {
            //global::System.Runtime.InteropServices.HandleRef swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, child);

            ImageView view = Registry.GetManagedBaseHandleFromNativePtr(child) as ImageView;

            Console.WriteLine("measureChild function called {0}", view.Name);
            return new MeasuredSize(90.0f,90.0f);
        }
        ...
        protected override void OnChildRemove(LayoutItem child)
        {
            ...
            for( int childIndex = 0; childIndex < count; childIndex++)
            {
                ...
                {
                    LayoutPINVOKE.FlexLayout_RemoveChildAt( swigCPtr, childIndex );
                    break;
                }
            }
        }
        ...
        protected override void OnMeasure( MeasureSpecification widthMeasureSpec, MeasureSpecification heightMeasureSpec )
        {
            ...
            LayoutPINVOKE.FlexLayout_SetMargin(swigCPtr, Extents.getCPtr(margin));
            LayoutPINVOKE.FlexLayout_SetPadding(swigCPtr, Extents.getCPtr(margin));
    ...
    //     YGNodeStyleSetMaxHeight( _yogaRoot, YGUndefined );
            ...
            if( widthMeasureSpec.Mode == MeasureSpecification.ModeType.Exactly ||  widthMeasureSpec.Mode == MeasureSpecification.ModeType.AtMost )
            {
                ...
                LayoutPINVOKE.FlexLayout_SetFlexMaximumWidth( swigCPtr, width );
            }
            ...
            if ( heightMeasureSpec.Mode == MeasureSpecification.ModeType.Exactly || heightMeasureSpec.Mode == MeasureSpecification.ModeType.AtMost )
            {
                ...
                LayoutPINVOKE.FlexLayout_SetFlexMaximumHeight( swigCPtr, height );
            }
        ...
        protected override void OnLayout( bool changed, LayoutLength left, LayoutLength top, LayoutLength right, LayoutLength bottom )
        {
            ...
            for( int childIndex = 0; childIndex < count; childIndex++)
            {
                ...
                if( childLayout != null )
                {
                    ...
                    Vector4 frame = new Vector4(LayoutPINVOKE.FlexLayout_GetNodeFrame(swigCPtr, childIndex ), true);

                    Console.WriteLine("OnLayout {0},{1},{2},{3}\n", frame.X, frame.Y, frame.Z, frame.W );
