...
namespace Tizen.NUI
{
    ...
    internal class GridLayout : LayoutGroupEx
    {
        ...
        protected override void OnMeasure( MeasureSpecification widthMeasureSpec, MeasureSpecification heightMeasureSpec )
        {
            ...
            _locations.CalculateLocations( _columns, availableContentWidth, availableContentHeight, childCount, 0, 0 );
        ...
        void OnLayout( bool changed, LayoutLengthEx left, LayoutLengthEx top, LayoutLengthEx right, LayoutLengthEx bottom )
        {
