...
namespace Tizen.NUI
{
    ...
    internal class GridLocations
    {
                                        ...
                                        int columnWidth, int rowHeight )
        {
            ...
            uint numberOfRows = (uint)(numberOfCells/numberOfColumns);
            // If number of cells not cleanly dividable by columns, add another row to house remainder cells.
            numberOfRows += (numberOfCells%numberOfColumns > 0) ? 1u:0u;

            int maxColumnWidth = (int)(availableWidth / numberOfColumns);
            ...
            int maxRowHeight = (int)(availableHeight / numberOfRows);
            ...
            Log.Info( "NUI", "Remainder:" +  numberOfCells%numberOfColumns + "\n");
