...
namespace Tizen.NUI
{
    ...
    internal class LayoutController : global::System.IDisposable
    {
        ...
        /// <summary>
        /// Constructs a LayoutController singleton which controls the measuring and layouting.<br />
        /// </summary>
        public LayoutController()
        {
            ...
            global::System.IntPtr cPtr = NDalicManualPINVOKE.Register_NewLayoutController();

            swigCPtr = new global::System.Runtime.InteropServices.HandleRef(this, cPtr);

            mInstance = new Callback(Handler);
            Console.WriteLine("C# LayoutController SetCallback");
            //NDalicManualPINVOKE.Register_NewLayoutController();
