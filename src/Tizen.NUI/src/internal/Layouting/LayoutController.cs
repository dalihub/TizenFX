...
namespace Tizen.NUI
{
    ...
    internal class LayoutController : global::System.IDisposable
    {
        ...
        private void Process(int id)
        {
            ...
            MeasureHierarchy( root, root.LayoutEx.OldWidthMeasureSpec, root.LayoutEx.OldHeightMeasureSpec );

            // Start at root with it's widthSpec and heightSpec
            PerformLayout( root, 0, 0, root.LayoutEx.OldWidthMeasureSpec, root.LayoutEx.OldHeightMeasureSpec );
        }
