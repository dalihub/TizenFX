...
namespace Tizen.NUI
{
    ...
    internal class LayoutController : global::System.IDisposable
    {
        ...
        public LayoutController()
        {
            ...
            NDalicManualPINVOKE.LayoutController_SetCallback(unmanagedLayoutController, mInstance);
        }
        ...
        protected virtual void Dispose(DisposeTypes type)
        {
            ...
            {
                NDalicManualPINVOKE.delete_LayoutController(unmanagedLayoutController);
