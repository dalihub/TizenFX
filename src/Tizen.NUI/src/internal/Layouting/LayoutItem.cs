...
namespace Tizen.NUI
{
    ...
    internal class LayoutItem : LayoutItemWrapper
    {
        ...
        /// 2. if the owner's View.LayoutWidthSpecification has View.ChildLayoutData.WrapContent then the width is set based on suggested minimum width see <see cref="LayoutItem.GetSuggestedMinimumWidth()" />).<br />
        ...
        /// 2. if the owner's View.LayoutHeightSpecification has View.ChildLayoutData.WrapContent then the height is set based on suggested minimum height see <see cref="LayoutItem.GetSuggestedMinimumHeight()" />).<br />
