...
namespace Tizen.NUI
{
    ...
    internal class LayoutItemEx
    {
        ...
        /// </summary>
        public LayoutLengthEx MeasuredWidth{ get; set; }

        /// <summary>
        /// Get the measured height (without any measurement flags).<br />
        /// This method should be used only during measurement and layout calculations.<br />
        /// </summary>
        public LayoutLengthEx MeasuredHeight{ get; set; }
        ...
        public MeasuredSizeEx MeasuredWidthAndState
        {
            get
            {
                return new MeasuredSizeEx();//GetMeasuredWidthAndState();
            }
        }
        ...
        public MeasuredSizeEx MeasuredHeightAndState
        {
            get
            {
                return new MeasuredSizeEx();//GetMeasuredHeightAndState();
            }
        }
        ...
        public LayoutLengthEx SuggestedMinimumWidth
        {
            get
            {
                return new LayoutLengthEx(0);//GetSuggestedMinimumWidth();
            }
        }
        ...
        void SetMeasuredDimensions( MeasuredSizeEx measuredWidth, MeasuredSizeEx measuredHeight )
        {
