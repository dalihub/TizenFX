...
namespace Tizen.NUI
{
    ...
    internal class LayoutItemEx
    {
        ...
        private View Owner;  // Should not keep a View alive.
        MeasuredSize MinimumSize;

        MeasureSpec OldWidthMeasureSpec;
        MeasureSpec OldHeightMeasureSpec;

        LayoutLengthEx Left;
        LayoutLengthEx Right;
        LayoutLengthEx Top;
        LayoutLengthEx Bottom;
        ...
        internal void Measure(MeasureSpec widthMeasureSpec, MeasureSpec heightMeasureSpec)
        {
        ...
        public static LayoutLengthEx GetDefaultSize(LayoutLengthEx size, MeasureSpec measureSpec)
        {
            LayoutLengthEx result = size;
            MeasureSpec.ModeType specMode = measureSpec.Mode;
            LayoutLengthEx specSize = measureSpec.Size;

            switch (specMode)
            {
              case MeasureSpec.ModeType.Unspecified:
              {
                result = size;
                break;
              }
              case MeasureSpec.ModeType.AtMost:
              {
              ...
              case MeasureSpec.ModeType.Exactly:
              {
               // result = specSize;
                break;
              }
        ...
        {
            return true; // todo Get PRIVATE_FLAG_FORCE_LAYOUT flag
        }
        ...
        public LayoutLength MeasuredWidth
        {
            get
            {
                return new LayoutLength(0);//GetMeasuredWidth();
            }
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetMeasuredWidth();
        }
        ...
        public LayoutLength MeasuredHeight
        {
            get
            {
                return new LayoutLength(0);//GetMeasuredHeight();
            }
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetMeasuredHeight();
        }
        ...
        public MeasuredSize MeasuredWidthAndState
        {
            get
            {
                return new MeasuredSize();//GetMeasuredWidthAndState();
            }
        }
        ...
        {
            return new MeasuredSize();//layoutItemWrapperImpl.GetMeasuredWidthAndState();
        }
        ...
        public MeasuredSize MeasuredHeightAndState
        {
            get
            {
                return new MeasuredSize();//GetMeasuredHeightAndState();
            }
        }
        ...
        {
            return new MeasuredSize();//layoutItemWrapperImpl.GetMeasuredHeightAndState();
        }
        ...
        public LayoutLength SuggestedMinimumWidth
        {
            get
            {
                return new LayoutLength(0);//GetSuggestedMinimumWidth();
            }
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetSuggestedMinimumWidth();
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetSuggestedMinimumHeight();
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetMinimumWidth();
        }
        ...
        {
            return new LayoutLength(0);//layoutItemWrapperImpl.GetMinimumHeight();
        }
        ...
        /// <param name="widthMeasureSpec">horizontal space requirements as imposed by the parent.</param>
        /// <param name="heightMeasureSpec">vertical space requirements as imposed by the parent.</param>
        protected virtual void OnMeasure(MeasureSpec widthMeasureSpec, MeasureSpec heightMeasureSpec)
        {
