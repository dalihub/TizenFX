...
namespace Tizen.NUI
{
    ...
    internal class LayoutItemEx
    {
        ...
        internal void Measure(LayoutMeasureSpec widthMeasureSpec, MeasureSpec heightMeasureSpec)
        {
        ...
        public LayoutItemEx(LayoutLengthEx left, LayoutLengthEx top, LayoutLengthEx right, LayoutLengthEx bottom)
        {
        ...
        public static LayoutLengthEx GetDefaultSize(LayoutLengthEx size, MeasureSpec measureSpec)
        {
            ...
            MeasureSpec.ModeType specMode = measureSpec.GetMode();
            LayoutLengthEx specSize = measureSpec.GetSize();
            ...
            switch (specMode)
            {
              ...
              case MeasureSpec::AtMost:
              {
                ...
                if( size < tmp && size > LayoutLengthEx( 0 ) )
                {
                  result = size;
                }
                else
