...
namespace Tizen.NUI
{
    ...
    internal class LinearLayout : LayoutGroupWrapper
    {
        ...
        {
            public static readonly float WEIGHT = LayoutPINVOKE.LinearLayout_ChildProperty_WEIGHT_get();
        }
        ...
        public enum Alignment
        {
            ...
            CenterHorizontal          = 0x4,  ///< At the horizontal center of the container
            Top                       = 0x8,  ///< At the top edge of the container
            Bottom                    = 0x10, ///< At the bottom edge of the container
            CenterVertical            = 0x20  ///< At the vertical center of the container
        }
