...
namespace Tizen.NUI
{
    ...
    internal class LinearLayoutEx : LayoutGroupEx
    {
        ...
        private void MeasureHorizontal(MeasureSpecification widthMeasureSpec, MeasureSpecification heightMeasureSpec)
        {
            ...
            Log.Info("NUI", "Measuring [" + _children.Count + "] child with parent width mode:" + widthMode + ",height mode:" + heightMode + "\n");
            ...
            foreach( LayoutItemEx childLayout in _children )
            {
                ...
                // allFillParent = ( allFillParent && desiredHeight == Toolkit::LayoutParamPolicies::MATCH_PARENT );
                // if( childWeight > 0 )
                // {
                //   /*
