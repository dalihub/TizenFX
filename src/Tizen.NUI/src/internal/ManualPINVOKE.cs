...
namespace Tizen.NUI
{
    class NDalicManualPINVOKE
    {
        ...
        public static extern global::System.IntPtr Register_NewLayoutController_gl();
        ...
        public static extern global::System.IntPtr Register_NewLayoutController_vulkan();

        public static global::System.IntPtr Register_NewLayoutController()
        {
            if (Tizen.NUI.Graphics.Backend == Tizen.NUI.Graphics.BackendType.Vulkan)
            {
                return Register_NewLayoutController_vulkan();
            }
            else
            {
                return Register_NewLayoutController_gl();
            }
        }
