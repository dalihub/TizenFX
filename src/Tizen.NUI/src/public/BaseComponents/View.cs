        ...
        public Extents Padding
        {
            ...
            set
            {
                if (Layout !=null)
                {
                    ...
                    SetValue(PaddingProperty, new Extents(0,0,0,0)); // Reset value stored in View.
                    NotifyPropertyChanged();
        ...
        internal LayoutItem Layout
        {
            ...
            set
            {
                ...
                if (value.Owner != null)
                {
                    ...
                    // Copy Margin and Padding to replacement layout.
                    value.Owner.Layout.Margin = value.Margin;
                    value.Owner.Layout.Padding = value.Padding;
                }

                // If View has a layout which already stores a Margin or Padding then restore it to the View.
                // As previously the layout would have moved the values from the View.
