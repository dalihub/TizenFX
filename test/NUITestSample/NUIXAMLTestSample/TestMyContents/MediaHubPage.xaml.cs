...
namespace Tizen.NUI.Examples
{
    public class MediaHubPage : ContentPage
    {
        ...
        {
            contentTable = Root.FindChildByName("ContentTable") as TableView;
            optionList = Root.FindChildByName("OptionList") as TableView;
            // FocusManager.Instance.SetCurrentFocusView(contentTable.GetChildAt(new TableView.CellPosition(0,0)));
